...
DROP TABLE IF EXISTS "CLI_API_KEY";
...
CREATE TABLE "CLI_API_KEY" (
    "API_KEY_ID" VARCHAR(256) NOT NULL,
    "ORG_ID" VARCHAR(256) NOT NULL,
...
CREATE INDEX "IDX_CLI_API_KEY_ORG_USER_STATUS" ON "CLI_API_KEY" ("ORG_ID", "USER_ID", "STATUS");
CREATE INDEX "IDX_CLI_API_KEY_EXPIRED_AT" ON "CLI_API_KEY" ("EXPIRED_AT");
